...
This profile records the current role of `llm-systems-research-ledger` in the Modern LLM Systems 2026 program.

| Field | Value |
|---|---|
| Repository | [llm-systems-research-ledger](https://github.com/Shoko-official/llm-systems-research-ledger) |
...
This repository acts as the auditable registry of research facts. It does not implement runtime code, RAG search pipelines, serving simulators, evaluation metrics, or paper compilation logic.

## Working Rules

| Rule | Value |
|---|---|
| Direct work on `main` | No |
